  ...
  return (
    <>
      ...
      <div className="space-y-8 pt-2">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="flex-1">
                  <h4 className="text-base font-semibold text-gray-900 mb-1">Resume</h4>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="flex-1">
                  <h4 className="text-base font-semibold text-gray-900 mb-1">Report</h4>
        ...
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-4">Recently Files</h3>
